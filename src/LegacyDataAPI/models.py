...
class LegacyUsers(models.Model):
    ...
    firstNameCN = models.CharField(
        verbose_name="中文名", max_length=50, null=True)
    ...
    gender = models.CharField(
        verbose_name="性别", choices=genderChoice, default='O', max_length=5)

    # 日期格式统一 “YYYY-MM-DD”
    dateOfBirth = models.DateTimeField(verbose_name="生日", null=True)
    # 使用表单自动记录的取值，2018年的数据需要进行UNIX时间戳转换
    ...
    membershipId = models.CharField(
        verbose_name="会员卡号", max_length=10, null=True)
