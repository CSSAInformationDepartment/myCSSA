...
class LegacyUserSerializers(serializers.ModelSerializer):
    class Meta:
        fields = ('firstNameEN', 'lastNameEN', 'gender', 'dateOfBirth',
                  'studentId', 'membershipId', 'telNumber', 'email')
        model = models.LegacyUsers
        read_only_fields = ('firstNameEN', 'lastNameEN', 'gender',
                            'dateOfBirth', 'studentId', 'membershipId', 'telNumber', 'email')
