...
urlpatterns = [
    ...
    path('password_reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="password_reset_confirm.html", success_url="/hub/password_reset_complete"), name='password_reset_confirm'),
