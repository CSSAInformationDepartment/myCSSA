...
urlpatterns = [
    ...
    path('notification/notifications_list/', Views.NotificationsList, name="notifications_list"),
    path('notification/notifications_form/', Views.NotificationForm.as_view(), name="notifications_form"),
    path('notification/notifications_display/', Views.NotificationsDisplay.as_view(), name="notifications_display"),
